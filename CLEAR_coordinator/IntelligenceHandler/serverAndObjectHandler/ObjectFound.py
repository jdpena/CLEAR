...
class ObjectFound() :
    ...
    #Checks object status, and then dXXXces a time that it takes for status 
    ...
    def similarityCheck(self, otherObject) :
        ...
        # print("Object disimilarity : {}".format(objectDissimilarity))
    ...
    def updateToOtherObject(self, otherObject) :
        ...
        # print ("object {} updated".format(self.tag))
        return self
    ...
    def updateObject(self, otherObjects, threshold = 60) :
        ...
        if lowestObj != None :
            ...
            # if lowestValue < 0 :
            #     self.tooOldTimer += self.tooOldTimer/10
